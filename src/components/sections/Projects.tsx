...
/**
 * 项目 2（11 张混合比例）：按「横幅 / 横版条 / 竖版条」分层编排。
...
const P2: Comp = {
  x2xl: [
    r([[2, 2.4], [7, 2.4]]),
    r([[0, 1], [4, 1.33], [3, 1], [10, 0.81], [1, 0.75]]),
    r([[5, 0.75], [6, 0.75], [8, 0.75], [9, 0.75]]),
  ],
  xl: [
    { tiles: [{ i: 2, a: 2.4 }, { i: 7, a: 2.4 }] },
    { tiles: [{ i: 0, a: 1 }, { i: 4, a: 1.33 }, { i: 3, a: 1 }, { i: 10, a: 0.81 }] },
    { tiles: [{ i: 1, a: 0.75 }, { i: 5, a: 0.75 }, { i: 6, a: 0.75 }, { i: 8, a: 0.75 }, { i: 9, a: 0.75 }] },
  ],
  md: [
    { tiles: [{ i: 2, a: 2.4 }, { i: 1, a: 0.75 }] },
    { tiles: [{ i: 7, a: 2.4 }, { i: 10, a: 0.81 }] },
  ...
  base: [
    ...
    { tiles: [{ i: 1, a: 0.75 }, { i: 5, a: 0.75 }] },
    { tiles: [{ i: 6, a: 0.75 }, { i: 8, a: 0.75 }, { i: 9, a: 0.75 }] },
  ],
}
